...
- 调试排错 Java 问题排查之使用IDEA本地调试和远程调试
  ...
  - [中断Debug](#中断debug)
  - 远程调试(Remote Debug)
    - [使用特定JVM参数运行服务端代码](#使用特定jvm参数运行服务端代码)
    - [本地连接远程服务器debug端口](#本地连接远程服务器debug端口)
    - [设置断点，开始调试](#设置断点开始调试)
  - [参考文章](#参考文章)
...
![img](https://lixuanfengs.github.io/blog-images/vp/Java/java-debug-idea-1.png)

在设置里勾选Show debug window on breakpoint，则请求进入到断点后自动激活Debug窗口

![img](https://lixuanfengs.github.io/blog-images/vp/Java/java-debug-idea-2.png)

如果你的IDEA底部没有显示工具栏或状态栏，可以在View里打开，显示出工具栏会方便我们使用。可以自己去尝试下这四个选项。

![img](https://lixuanfengs.github.io/blog-images/vp/Java/java-debug-idea-3.png)

在菜单栏Run里有调试对应的功能，同时可以查看对应的快捷键。

![img](https://lixuanfengs.github.io/blog-images/vp/Java/java-debug-idea-4.png)
...
![img](https://lixuanfengs.github.io/blog-images/vp/Java/java-debug-idea-5.png)
...
![img](https://lixuanfengs.github.io/blog-images/vp/Java/java-debug-idea-6.png)
...
![img](https://lixuanfengs.github.io/blog-images/vp/Java/java-debug-idea-7.png)

![img](https://lixuanfengs.github.io/blog-images/vp/Java/java-debug-idea-8.png)
...
![img](https://lixuanfengs.github.io/blog-images/vp/Java/java-debug-idea-9.png)

- 光标悬停到参数上，显示当前变量信息。点击打开详情如下图。我一般会使用这种方式，快捷方便。

![img](https://lixuanfengs.github.io/blog-images/vp/Java/java-debug-idea-10.png)

![img](https://lixuanfengs.github.io/blog-images/vp/Java/java-debug-idea-11.png)

- 在Variables里查看，这里显示当前方法里的所有变量。

![img](https://lixuanfengs.github.io/blog-images/vp/Java/java-debug-idea-12.png)

- 在Watches里，点击New Watch，输入需要查看的变量。或者可以从Variables里拖到Watche里查看。

![img](https://lixuanfengs.github.io/blog-images/vp/Java/java-debug-idea-13.png)

如果你发现你没有Watches，可能在下图所在的地方。

![img](https://lixuanfengs.github.io/blog-images/vp/Java/java-debug-idea-14.png)

![img](https://lixuanfengs.github.io/blog-images/vp/Java/java-debug-idea-15.png)

## [#](#计算表达式) 计算表达式

> 在前面提到的计算表达式如下图的按钮，Evaluate Expression (Alt + F8) 。可以使用这个操作在调试过程中计算某个表达式的值，而不用再去打印信息。

![img](https://lixuanfengs.github.io/blog-images/vp/Java/java-debug-idea-16.png)

- 按Alt + F8或按钮，或者，你可以选中某个表达式再Alt + F8，弹出计算表达式的窗口，如下，回车或点击Evaluate计算表达式的值。

这个表达式不仅可以是一般变量或参数，也可以是方法，当你的一行代码中调用了几个方法时，就可以通过这种方式查看查看某个方法的返回值。

![img](https://lixuanfengs.github.io/blog-images/vp/Java/java-debug-idea-17.png)

- 设置变量，在计算表达式的框里，可以改变变量的值，这样有时候就能很方便我们去调试各种值的情况了不是。

![img](https://lixuanfengs.github.io/blog-images/vp/Java/java-debug-idea-18.png)
...
![img](https://lixuanfengs.github.io/blog-images/vp/Java/java-debug-idea-19.png)

按Shift + F7，会自动定位到当前断点行，并列出需要进入的方法，如图5.2，点击方法进入方法内部。

如果只有一个方法，则直接进入，类似Force Step Into。

![img](https://lixuanfengs.github.io/blog-images/vp/Java/java-debug-idea-20.png)
...
![img](https://lixuanfengs.github.io/blog-images/vp/Java/java-debug-idea-21.png)
...
![img](https://lixuanfengs.github.io/blog-images/vp/Java/java-debug-idea-22.png)

![img](https://lixuanfengs.github.io/blog-images/vp/Java/java-debug-idea-23.png)
...
![img](https://lixuanfengs.github.io/blog-images/vp/Java/java-debug-idea-25.png)

![img](https://lixuanfengs.github.io/blog-images/vp/Java/java-debug-idea-26.png)

- **异常断点，通过设置异常断点，在程序中出现需要拦截的异常时，会自动定位到异常行**。

如下图，点击+号添加Java Exception Breakpoints，添加异常断点。然后输入需要断点的异常类

![img](https://lixuanfengs.github.io/blog-images/vp/Java/java-debug-idea-27.png)

之后可以在Java Exception Breakpoints里看到添加的异常断点。

![img](https://lixuanfengs.github.io/blog-images/vp/Java/java-debug-idea-28.png)

这里添加了一个NullPointerException异常断点，出现空指针异常后，自动定位在空指针异常行。

![img](https://lixuanfengs.github.io/blog-images/vp/Java/java-debug-idea-29.png)
...
![img](https://lixuanfengs.github.io/blog-images/vp/Java/java-debug-idea-30.png)

切换线程，在下图中Frames的下拉列表里，可以切换当前的线程，如下我这里有两个Debug的线程，切换另外一个则进入另一个Debug的线程。

![img](https://lixuanfengs.github.io/blog-images/vp/Java/java-debug-idea-31.png)
...
![img](https://lixuanfengs.github.io/blog-images/vp/Java/java-debug-idea-32.png)
...
![img](https://lixuanfengs.github.io/blog-images/vp/Java/java-debug-idea-33.png)

取消Show All Frames按钮会显示三方类库的方法

![img](https://lixuanfengs.github.io/blog-images/vp/Java/java-debug-idea-34.png)

第二种方式，在调用栈方法上选择要回退的方法，右键选择Drop Frame，回退到该方法的上一个方法调用处，此时再按F9(Resume Program)，可以看到程序进入到该方法的断点处了。

![img](https://lixuanfengs.github.io/blog-images/vp/Java/java-debug-idea-35.png)
...
![img](https://lixuanfengs.github.io/blog-images/vp/Java/java-debug-idea-36.png)

点击Force Return，弹出Return Value的窗口，我这个方法的返回类型为Map，所以，我这里直接返回 results，来强制返回，从而不再进行后续的流程。或者你可以`new HashMap<>()`。

![img](https://lixuanfengs.github.io/blog-images/vp/Java/java-debug-idea-37.png)

## [#](#远程调试-remote-debug) 远程调试(Remote Debug)
...
![img](https://lixuanfengs.github.io/blog-images/vp/Java/java-debug-idea-41.png)
...
![img](https://lixuanfengs.github.io/blog-images/vp/Java/java-debug-idea-42.png)
...
![img](https://lixuanfengs.github.io/blog-images/vp/Java/java-debug-idea-43.png)
