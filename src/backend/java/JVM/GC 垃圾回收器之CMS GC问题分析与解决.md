...
![img](https://lixuanfengs.github.io/blog-images/vp/Java/cms-gc-1.png)
...
![img](https://lixuanfengs.github.io/blog-images/vp/Java/cms-gc-2.jpg)
...
![img](https://lixuanfengs.github.io/blog-images/vp/Java/cms-gc-3.png)

把 mark、sweep、compaction、copying 这几种动作的耗时放在一起看，大致有这样的关系：

![img](https://lixuanfengs.github.io/blog-images/vp/Java/cms-gc-4.jpg)
...
![img](https://lixuanfengs.github.io/blog-images/vp/Java/cms-gc-5.jpg)

> 备注：值得一提的是，早些年国内 GC 技术的布道者 RednaxelaFX （江湖人称 R 大）也曾就职于 Azul，本文的一部分材料也参考了他的一些文章。

#### [#](#_2-5-1-分代收集器) 2.5.1 分代收集器
...
![img](https://lixuanfengs.github.io/blog-images/vp/Java/cms-gc-6.jpg)

#### [#](#_2-5-3-常用收集器) 2.5.3 常用收集器

目前使用最多的是 CMS 和 G1 收集器，二者都有分代的概念，主要内存结构如下：

![img](https://lixuanfengs.github.io/blog-images/vp/Java/cms-gc-7.png)

#### [#](#_2-5-4-其他收集器) 2.5.4 其他收集器
...
![img](https://lixuanfengs.github.io/blog-images/vp/Java/cms-gc-8.jpg)
...
#### [#](#_3-1-2-读懂-gc-cause) 3.1.2 读懂 GC Cause

拿到 GC 日志，我们就可以简单分析 GC 情况了，通过一些工具，我们可以比较直观地看到 Cause 的分布情况，如下图就是使用 gceasy 绘制的图表：

![img](https://lixuanfengs.github.io/blog-images/vp/Java/cms-gc-9.png)
...
### [#](#_3-2-判断是不是-gc-引发的问题) 3.2 判断是不是 GC 引发的问题？
...
### [#](#_3-3-问题分类导读) 3.3 问题分类导读

#### [#](#_3-3-1-mutator-类型) 3.3.1 Mutator 类型
...
![img](https://lixuanfengs.github.io/blog-images/vp/Java/cms-gc-10.jpg)

#### [#](#_3-3-2-gc-问题分类) 3.3.2 GC 问题分类
...
## [#](#_4-常见场景分析与解决) 4. 常见场景分析与解决

### [#](#_4-1-场景一-动态扩容引起的空间震荡) 4.1 场景一：动态扩容引起的空间震荡
...
![img](https://lixuanfengs.github.io/blog-images/vp/Java/cms-gc-11.png)
...
![img](https://lixuanfengs.github.io/blog-images/vp/Java/cms-gc-12.jpg)
...
### [#](#_4-2-场景二-显式-gc-的去与留) 4.2 场景二：显式 GC 的去与留
...
### [#](#_4-3-场景三-metaspace-区-oom) 4.3 场景三：MetaSpace 区 OOM
...
![img](https://lixuanfengs.github.io/blog-images/vp/Java/cms-gc-13.png)
...
![img](https://lixuanfengs.github.io/blog-images/vp/Java/cms-gc-14.png)
...
![img](https://lixuanfengs.github.io/blog-images/vp/Java/cms-gc-15.png)
...
![img](https://lixuanfengs.github.io/blog-images/vp/Java/cms-gc-16.jpg)

![img](https://lixuanfengs.github.io/blog-images/vp/Java/cms-gc-32.jpg)
...
### [#](#_4-5-场景五-cms-old-gc-频繁) 4.5 场景五：CMS Old GC 频繁
...
![img](https://lixuanfengs.github.io/blog-images/vp/Java/cms-gc-17.jpg)
...
![img](https://lixuanfengs.github.io/blog-images/vp/Java/cms-gc-18.png)

#### [#](#_4-5-4-小结) 4.5.4 小结

经过整个流程下来基本就能定位问题了，不过在优化的过程中记得使用**控制变量**的方法来优化，防止一些会加剧问题的改动被掩盖。

### [#](#_4-6-场景六-单次-cms-old-gc-耗时长) 4.6 场景六：单次 CMS Old GC 耗时长*

#### [#](#_4-6-1-现象) 4.6.1 现象

CMS GC 单次 STW 最大超过 1000ms，不会频繁发生，如下图所示最长达到了 8000ms。某些场景下会引起“雪崩效应”，这种场景非常危险，我们应该尽量避免出现。

![img](https://lixuanfengs.github.io/blog-images/vp/Java/cms-gc-19.png)
...
![img](https://lixuanfengs.github.io/blog-images/vp/Java/cms-gc-20.jpg)
...
![img](https://lixuanfengs.github.io/blog-images/vp/Java/cms-gc-21.jpg)
...
### [#](#_4-7-场景七-内存碎片-收集器退化) 4.7 场景七：内存碎片&收集器退化
...
![img](https://lixuanfengs.github.io/blog-images/vp/Java/cms-gc-22.png)
...
### [#](#_4-8-场景八-堆外内存-oom) 4.8 场景八：堆外内存 OOM
...
![img](https://lixuanfengs.github.io/blog-images/vp/Java/cms-gc-23.png)
...
![img](https://lixuanfengs.github.io/blog-images/vp/Java/cms-gc-24.png)

最终定位到是，项目中对 GIPInputStream 的使用错误，没有正确的 close()。

![img](https://lixuanfengs.github.io/blog-images/vp/Java/cms-gc-25.png)
...
![img](https://lixuanfengs.github.io/blog-images/vp/Java/cms-gc-26.png)

### [#](#_4-9-场景九-jni-引发的-gc-问题) 4.9 场景九：JNI 引发的 GC 问题
...
![img](https://lixuanfengs.github.io/blog-images/vp/Java/cms-gc-27.png)
...
- 升级 JDK 版本到 14，避免 [JDK-8048556在新窗口打开](https://bugs.openjdk.java.net/browse/JDK-8048556) 导致的重复 GC。

![img](https://lixuanfengs.github.io/blog-images/vp/Java/cms-gc-28.png)
...
### [#](#_5-1-处理流程-sop) 5.1 处理流程（SOP）

下图为整体 GC 问题普适的处理流程，重点的地方下面会单独标注，其他的基本都是标准处理流程，此处不再赘述，最后在整个问题都处理完之后有条件的话建议做一下复盘。

![img](https://lixuanfengs.github.io/blog-images/vp/Java/cms-gc-29.jpg)
...
![img](https://lixuanfengs.github.io/blog-images/vp/Java/cms-gc-31.png)
