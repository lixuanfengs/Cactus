...
### [#](#stream-parallelstream-1) stream & parallelStream
...
![img](https://lixuanfengs.github.io/blog-images/vp/Java/java-stream-functions.png)
...
### [#](#min-max-summarystatistics) min,max,summaryStatistics
...
上面的模式串接受任何以`@gmail.com`结尾的字符串，并且之后用作Java8的Predicate来过滤电子邮件地址流。
