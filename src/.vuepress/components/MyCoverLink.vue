...
.link-card {
  ...
  min-height: 10rem;
  color: inherit;
  background-image: linear-gradient(to top, #7873f5 0%, #97d9e1 33%, #ec77ab 100%);
...
a.card-body {
  --light: #f8f9fa;
  border-radius: 0.5rem;
  box-shadow: 0 0.2rem 1rem 0 rgba(0, 0, 0, 0.5), 0 0 0 2px rgba(255, 255, 255, 0.15);
  display: inline-block;
  width: 100%;
  height: 100%;
  ...
  .card-content {
    ...
    .link-avatar {
      ...
      img {
        ...
        object-fit: contain;
        box-shadow: 0 0 0 0.2rem rgba(195, 195, 195, 0.2), 0 0 0 0.4rem rgba(195, 195, 195, 0.1);
    ...
    .link-text {
      ...
      text-align: center;
      padding: 0 0.8rem;
      font-family: ZWZT, '-apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Oxygen, Ubuntu, Cantarell, "Fira Sans", "Droid Sans", "Helvetica Neue", STHeiti, "Microsoft YaHei", SimSun, sans-serif';
