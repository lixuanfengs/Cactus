...
- 调试排错 Java动态调试技术原理
  - [简介](#简介)
  - Agent的实现模式
    - [通过Java Instrumentation API](#通过java-instrumentation-api)
  - 启动时加载Agent
    - [参数解析](#参数解析)
    - [执行加载操作](#执行加载操作)
    - [instrument动态链接库](#instrument动态链接库)
  - 运行时加载Agent
    - [AttachListener](#attachlistener)
    - [运行时加载Agent的实现](#运行时加载agent的实现)
    - [load命令的实现](#load命令的实现)
  - [动态字节码修改的限制](#动态字节码修改的限制)
  - [重定义类字节码的实现细节](#重定义类字节码的实现细节)
  - Java-debug-tool
    - [Java-debug-tool整体架构](#java-debug-tool整体架构)
    - Java-debug-tool的字节码增强方案
      - [字节码增强](#字节码增强)
      - [Advice的工作方式](#advice的工作方式)
    - Java-debug-tool的命令设计与实现
      - [命令执行](#命令执行)
      - [获取方法执行视图](#获取方法执行视图)
    - [Java-debug-tool与同类产品对比分析](#java-debug-tool与同类产品对比分析)
  - [参考文献](#参考文献)
...
![img](https://lixuanfengs.github.io/blog-images/vp/Java/java-jvm-agent-1.png)
...
![img](https://lixuanfengs.github.io/blog-images/vp/Java/java-jvm-agent-2.png)
...
VM_RedefineClasses实现比较复杂的，详细实现可以参考 [RedefineClasses在新窗口打开](https://github.com/pandening/openjdk/blob/0301fc792ffd3c7b506ef78887af250e0e3ae09e/src/hotspot/share/prims/jvmtiEnv.cpp#L456)的实现。
...
![img](https://lixuanfengs.github.io/blog-images/vp/Java/java-jvm-agent-3.png)
...
### [#](#java-debug-tool的字节码增强方案) Java-debug-tool的字节码增强方案
...
![img](https://lixuanfengs.github.io/blog-images/vp/Java/java-jvm-agent-4.png)
...
![img](https://lixuanfengs.github.io/blog-images/vp/Java/java-jvm-agent-5.png)
...
### [#](#java-debug-tool的命令设计与实现) Java-debug-tool的命令设计与实现

#### [#](#命令执行) 命令执行

上文已经完整的描述了Java-debug-tool的设计以及核心技术方案，本小节将详细介绍Java-debug-tool的命令设计与实现。首先需要将一个调试命令的执行流程描述清楚，下面是一张用来表示命令请求处理流程的图片：

![img](https://lixuanfengs.github.io/blog-images/vp/Java/java-jvm-agent-6.png)
...
![img](https://lixuanfengs.github.io/blog-images/vp/Java/java-jvm-agent-7.png)

### [#](#java-debug-tool与同类产品对比分析) Java-debug-tool与同类产品对比分析

Java-debug-tool的同类产品主要是greys，其他类似的工具大部分都是基于greys进行的二次开发，所以直接选择greys来和Java-debug-tool进行对比。

![img](https://lixuanfengs.github.io/blog-images/vp/Java/java-jvm-agent-8.jpg)
...
- [ASM 4 guide在新窗口打开](https://asm.ow2.io/asm4-guide.pdf)
- [Java Virtual Machine Specification在新窗口打开](https://docs.oracle.com/javase/specs/jvms/se7/html/jvms-4.html)
- [JVM Tool Interface在新窗口打开](https://docs.oracle.com/javase/8/docs/platform/jvmti/jvmti.html)
- [alibaba arthas在新窗口打开](https://alibaba.github.io/arthas/)
