...
![jvm-framework](https://lixuanfengs.github.io/blog-images/vp/Java/0082zybply1gc6fz21n8kj30u00wpn5v.jpg)
...
![jvm-pc-counter](https://lixuanfengs.github.io/blog-images/vp/Java/0082zybply1gc5kmznm1sj31m50u0wph.jpg)
...
![img](https://lixuanfengs.github.io/blog-images/vp/Java/0082zybply1gc9lezaxrbj319v0u0k4w.jpg)

### [#](#_2-4-栈帧的内部结构) 2.4 栈帧的内部结构
...
![jvm-stack-frame](https://lixuanfengs.github.io/blog-images/vp/Java/0082zybply1gc8tjehg8bj318m0lbtbu.jpg)

继续深抛栈帧中的五部分~~

#### [#](#_2-4-1-局部变量表) 2.4.1. 局部变量表
...
![img](https://lixuanfengs.github.io/blog-images/vp/Java/0082zybply1gc9s12g5wlj31li0owdm9.jpg)

- 在栈帧中，与性能调优关系最为密切的就是局部变量表。在方法执行时，虚拟机使用局部变量表完成方法的传递
- **局部变量表中的变量也是重要的垃圾回收根节点，只要被局部变量表中直接或间接引用的对象都不会被回收**

#### [#](#_2-4-2-操作数栈) 2.4.2. 操作数栈
...
##### [#](#栈顶缓存-top-of-stack-cashing) 栈顶缓存（Top-of-stack-Cashing）
...
#### [#](#_2-4-3-动态链接-指向运行时常量池的方法引用) 2.4.3. 动态链接（指向运行时常量池的方法引用）
...
![jvm-dynamic-linking](https://lixuanfengs.github.io/blog-images/vp/Java/0082zybply1gca4k4gndgj31d20o2td0.jpg)
...
#### [#](#_2-4-4-方法返回地址-return-address) 2.4.4. 方法返回地址（return address）
...
### [#](#_3-2-本地方法栈-native-method-stack) 3.2 本地方法栈（Native Method Stack）
...
![JDK7](https://lixuanfengs.github.io/blog-images/vp/Java/00831rSTly1gdbr7ek6pfj30ci0560t4.jpg)
...
![img](https://lixuanfengs.github.io/blog-images/vp/Java/007S8ZIlly1gg06065oa9j31kw0u0q69.jpg)
...
### [#](#_4-2-设置堆内存大小和-oom) 4.2 设置堆内存大小和 OOM
...
### [#](#_4-3-对象在堆中的生命周期) 4.3 对象在堆中的生命周期
...
### [#](#_4-7-堆是分配对象存储的唯一选择吗) 4.7 堆是分配对象存储的唯一选择吗
...
### [#](#_5-2-设置方法区内存的大小) 5.2 设置方法区内存的大小
...
![img](https://lixuanfengs.github.io/blog-images/vp/Java/2021071108533517.png)

* Person：存放在元空间，也可以说方法区
* person：存放在Java栈的局部变量表中
* new Person()：存放在Java堆中

### [#](#_5-4-运行时常量池) 5.4 运行时常量池
...
![img](https://lixuanfengs.github.io/blog-images/vp/Java/007S8ZIlly1gg9i91ze2gj320i0riahe.jpg)
...
### [#](#_5-5-方法区在-jdk6、7、8中的演进细节) 5.5 方法区在 JDK6、7、8中的演进细节
...
- **@cactusli: HotSpot中字符串常量池保存哪里？永久代？方法区还是堆区**？
...
![img](https://lixuanfengs.github.io/blog-images/vp/Java/007S8ZIlly1gg04ve34c2j30z00u0dp7.jpg)
